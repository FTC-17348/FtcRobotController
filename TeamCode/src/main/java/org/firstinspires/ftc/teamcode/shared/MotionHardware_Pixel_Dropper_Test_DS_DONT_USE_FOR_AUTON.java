...
public class MotionHardware_Pixel_Dropper_Test_DS_DONT_USE_FOR_AUTON {
    ...
    public MotionHardware_Pixel_Dropper_Test_DS_DONT_USE_FOR_AUTON(LinearOpMode opmode) {
        myOpMode = opmode;
    }
    public MotionHardware_Pixel_Dropper_Test_DS_DONT_USE_FOR_AUTON(LinearOpMode opmode, GlobalConfig globalConfig) {
        myOpMode = opmode;
